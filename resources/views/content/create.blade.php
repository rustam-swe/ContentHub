...
<h1>Yangi content qo'shish</h1>
    <form action="/contents" method="POST">
        @csrf
        <div class="mb-3">
            <input type="text" class="form-control" name="title" required placeholder="Content's title"><br>
            <input type="text" class="form-control" name="description" required placeholder="Content's description"><br>
            <input type="text" class="form-control" name="url" required placeholder="Content's link"><br>
            ...
            <div id="selectAuthors">
                <div style="display: flex; align-items: center; margin-bottom: 10px;">
                    ...
                    <button type="button" id="addAuthorButton" class="add-btn"
                        style="margin-left: 10px; padding: 5px 10px; background-color: green; color: white; border: none; border-radius: 5px; cursor: pointer;">+</button>
                </div>
